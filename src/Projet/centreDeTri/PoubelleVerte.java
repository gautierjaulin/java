...
class PoubelleVerte extends Poubelle{
	...
	public boolean correspond(TypeDechet typeDepot,Integer idPoubelle) {
		//Vérification du type déposé par l'utilisateur
		if(typeDepot == TypeDechet.VERRE)
		{
			return(true);
		}
	...
	/**
	 * @brief	Constructeur de la classe PoubelleVerte
	 */
	
	public PoubelleVerte(int idPoubelle, String type, String emplacement) {
