...
class PoubelleBleue extends Poubelle{
	...
	public boolean correspond(String typeDepot,Integer idPoubelle) {
		...
		if(typeDepot.equals(String.valueOf(TypeDechet.PAPIER)))
		{
			return(true);
		}
	...
	/**
	 * @brief	Constructeur de la classe PoubelleBleue
	 */
	
	public PoubelleBleue(int idPoubelle, String type, String emplacement) {
